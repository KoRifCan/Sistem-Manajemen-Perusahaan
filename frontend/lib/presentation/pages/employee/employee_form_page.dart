              ...
              Row(
                children: [
                  Expanded(child: DropdownButtonFormField<String>(
                    ...
                    items: ['Laki-laki', 'Perempuan'].map((v) => DropdownMenuItem<String>(value: v, child: Text(v))).toList(),
                  ...
                  Expanded(child: DropdownButtonFormField<String>(
                    ...
                    items: AppConstants.religions.map((v) => DropdownMenuItem<String>(value: v, child: Text(v))).toList(),
              ...
              Row(
                children: [
                  Expanded(child: DropdownButtonFormField<String>(
                    ...
                    items: AppConstants.bloodTypes.map((v) => DropdownMenuItem<String>(value: v, child: Text(v))).toList(),
                  ...
                  Expanded(child: DropdownButtonFormField<String>(
                    ...
                    items: AppConstants.maritalStatus.map((v) => DropdownMenuItem<String>(value: v, child: Text(v))).toList(),
